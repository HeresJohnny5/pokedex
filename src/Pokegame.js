...
class Pokegame extends Component {
  ...
  render() {
    this.imgSrc(this.state.cards);

    this.shuffle(this.state.cards);

    const p1Cards = this.state.cards.slice(0, 4);
    const p2Cards = this.state.cards.slice(4);
    ...
    return (
      <div className='Pokegame'>
        ...
        <Pokedex cards={p1Cards} p1Total={this.p1Total} />
        <Pokedex cards={p2Cards} p2Total={this.p2Total} />
      </div>
    );
  }
}
